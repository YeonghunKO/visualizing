...
for line in fh:
    ...
    url = serviceurl + urllib.parse.urlencode(parms) ##This means "enter into serviceurl and search and find the geocode of the address"
    ...
    #     time.sleep(5)
    ##This block of code is to prevent your computer from blowing up, freezing , or whatever stops your computer due to overload data processing.
